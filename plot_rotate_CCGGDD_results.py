...
# Your log file path
log_path = "/proj/jchunglab/projects/ec_moa/RotatE/rotate_CCGGDD.log"
...
plt.title("RotatE CCGGDD Subgraph Training Loss")
plt.grid(True)
plt.tight_layout()
plt.savefig("rotate_CCGGDD_training_loss.png")
...
plt.title("RotatE CCGGDD Subgraph Training Loss (log scale)")
plt.yscale("log")
plt.grid(True)
plt.tight_layout()
plt.savefig("rotate_CCGGDD_training_loss_logscale.png")
...
plt.title("RotatE CCGGDD Subgraph Validation MRR")
plt.grid(True)
plt.tight_layout()
plt.savefig("rotate_CCGGDD_val_mrr.png")
...
plt.title("RotatE CCGGDD Subgraph Validation Hits@10")
plt.grid(True)
plt.tight_layout()
plt.savefig("rotate_CCGGDD_val_hits10.png")
...
plt.title("RotatE CCGGDD Subgraph Validation Mean Rank")
plt.grid(True)
plt.tight_layout()
plt.savefig("rotate_CCGGDD_val_mr.png")
